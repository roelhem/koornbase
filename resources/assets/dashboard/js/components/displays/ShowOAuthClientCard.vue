...
<script>
    ...
    import { revokeOAuthClient } from "../../apis/graphql/mutations/oauth.graphql";
    ...
    import UpdateOAuthClientForm from "../features/crud/UpdateOAuthClientForm";
    import DisplayOAuthClientType from "./DisplayOAuthClientType";
