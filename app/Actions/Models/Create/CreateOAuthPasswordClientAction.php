...
class CreateOAuthPasswordClientAction extends AbstractCreateAction
{
    ...
    /**
     * CreateOAuthPasswordClientAction constructor.
    ...
    protected function handle($validArgs = [], ?ActionContext $context = null)
    {
        ...
        $redirect = array_get($validArgs,'redirect') ?? 'http://localhost';

        return $this->repository->createPasswordGrantClient($userId,$name,$redirect);
    }
