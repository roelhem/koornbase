...
class ModelFinderServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton(SimpleFinderCollection::class, function($app) {
            ...
            $res->add(new ModelByIdFinder('person_address', PersonAddress::class));
            $res->add(new ModelByIdFinder('person_email_address', PersonEmailAddress::class));
            $res->add(new ModelByIdFinder('person_phone_number', PersonPhoneNumber::class));
